...
DESCRIPTION="Generic initramfs generation tool; aidecoe's fork"
HOMEPAGE="http://dracut.wiki.kernel.org"
EGIT_REPO_URI="git://github.com/aidecoe/${MY_PN}.git"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS=""
...
src_prepare() {
	epatch "${FILESDIR}/${PV}-multipath-udev-rules.patch"
}
