...
src_prepare() {
	# Essential fixes already applied by upstream
	epatch "${FILESDIR}"/${PV}-drm-reduce-minimum-build-requirements.patch
	epatch "${FILESDIR}"/${PV}-image-replace-deprecated-libpng-function.patch
